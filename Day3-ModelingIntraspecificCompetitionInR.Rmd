...
Alpha is often also called the "competition coefficient". When we are talking about a single species - alpha shows us how limiting that species is on itself. When we are talking about multiple species, each species has an alpha for itself and for the other species it is around. 
