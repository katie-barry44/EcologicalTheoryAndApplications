...
The theory lecture can be found [here](https://youtu.be/71YpbcYODtA) but will also be given live on Monday!   

You can also find the explanation for this week's modeling components [here](https://youtu.be/j-Cl-IZzzA4).  
...
The lecture on application can be found [here](https://youtu.be/xUgyXA4KyRg) but will also be given live on Wednesday!   
...
- 14:00 in front of the Natuurbelevingcentrum De Oostvaarders   
...
*Some extra literature can be found in the File labeled "Week 4 - Literature" on the Teams.* 
